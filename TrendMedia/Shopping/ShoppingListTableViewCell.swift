...
class ShoppingListTableViewCell: UITableViewCell {
    ...
    @IBAction func checkboxButtonTapped(_ sender: UIButton) {
        ...
        sender.isSelected ? checkboxButton.setImage(UIImage(systemName: "checkmark.square.fill"), for: .selected) : checkboxButton.setImage(UIImage(systemName: "checkmark.square"), for: .normal)
